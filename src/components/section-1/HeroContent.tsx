    ...
    <div className="mycontainer1 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  montserrat w-90vw md:max-w-[1140px]">
        ...
        <div className="w-full text-center text-white relative mb-10 md:mb-16">
            <h1 className="flex flex-col items-center">
                <span className="font-bold text-4xl md:text-6xl md:leading-[73px] mb-1">Welcome to <span>[School&nbsp;Name]</span></span>
                <span className="font-semibold text-sm md:text-3xl">Where Excellence Meets Opportunity</span>
            </h1>
